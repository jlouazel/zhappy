...
** Last update Mon Jul  1 23:40:36 2013 julien fortin
*/
...
bool            server_listen_player(const t_server *, fd_set *);
bool            server_will_notify_player(const t_server *, fd_set *);
bool		server_notify_player(const t_server *);
